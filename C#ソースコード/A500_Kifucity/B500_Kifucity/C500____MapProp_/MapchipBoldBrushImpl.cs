...
namespace Grayscale.A500_Kifucity.B500_Kifucity.C500____MapProp_
{
    ...
    public class MapchipBoldBrushImpl : MapchipBoldBrush
    {
            ...
            , int pRow, int pCol)
        {
            ...
            // （更新）中央
            ucMain.MapData1[this.Layer, pRow, pCol] = this.Patch;
            ...
            {
                if (
                    ucMain.MapData1[this.Layer, row, col] != this.Patch &&
                    ucMain.MapData2[this.Layer, row, col] != ImageType.Border_Sunachi
                    )
                {
                    // 塗りつぶすぜ☆（＾▽＾）
                    crop = this.Patch;
            ...
            , int centerRow, int centerCol)
        {
                ...
                -1 < centerRow && centerRow < UcMain.TABLE_ROWS)
            {
                ...
                // （更新）中央
                ucMain.MapData1[this.Layer, centerRow, centerCol] = this.Patch;
